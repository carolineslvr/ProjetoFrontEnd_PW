    ...
    return (
        <Dialogo id="modalEdicao" titulo="Produto"
            ...
            <CampoEntrada id="txtCodigo" label="Código" tipo="number"
                ...
                nome="codigo" value={objeto.codigo} onchange={handleChange}
                msgvalido="" msginvalido=""
                readonly={true} />
            <CampoEntrada id="txtNome" label="Nome" tipo="text"
                placeholder="Informe o nome" requerido="true"
                nome="nome" value={objeto.nome} onchange={handleChange}
            ...
            <CampoEntrada id="txtDescricao" label="Descrição" tipo="text"
                ...
                nome="descricao" value={objeto.descricao} onchange={handleChange}
            ...
            <CampoEntrada id="txtEstoque" label="Estoque" tipo="number"
                ...
                nome="quantidade_estoque" value={objeto.quantidade_estoque}
            ...
            <CampoEntrada id="txtData" label="Data de cadastro" tipo="date"
                ...
                nome="data_cadastro" value={objeto.data_cadastro}
                onchange={handleChange}
